...
- [ ] **Report retention:** suggest 12 months after resolution, then delete. Goes in the retention table.
- [ ] **Infrastructure log retention (nginx, mail):** suggest 14 days. IPs are personal data.
- [ ] **Backup retention:** suggest 30-day rotation, encrypted, off-box. Shorter retention = simpler GDPR story.
